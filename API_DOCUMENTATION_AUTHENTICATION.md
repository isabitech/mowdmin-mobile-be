...
1. **Welcome Email**: Sent after successful registration with enhanced HTML design
2. **Password Reset Email**: Sent with 4-digit token (expires in 10 minutes) with enhanced HTML design

**Email Configuration:**
- **Service**: Brevo API (formerly Sendinblue)
- **Sender**: "Mowdministries App" <isabitechng@gmail.com>
- **API**: Brevo Transactional Email API
- **Features**: 
  - Professional HTML templates with responsive design
  - Plain text fallback for better compatibility
  - Enhanced styling with branded colors
  - Improved user experience with clear call-to-actions

**Email Templates:**
- **Welcome Email**: Full HTML template with branding, welcome message, and next steps
- **Password Reset Email**: Secure token delivery with expiration notice and security warnings
- **Error Handling**: Comprehensive error logging with Brevo API response details
